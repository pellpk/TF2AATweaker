...
#define FCVAR_CROUTON			(1<<26) // backed by a string in memory
...
public:
	...
	ConVar(const char* pszName, const char* stringPtr, int bufferSize, int nFlags, const char* pszHelpString);
	ConVar(
		const char* pszName,
...
extern int g_soupDLLIdentifier;
